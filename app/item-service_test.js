...
describe("Item Service", function () {
    ...
    describe("Item Commands", function () {
        ...
        it("should drop single item only if in inventory", function () {
            ...
            expect(itemService.getAvailable().items["mock item"].canCarry).toBe(true);
